...
<head>
 ...
 Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
    ...
    <!-- Bootstrap-Core-CSS -->
    <link rel="stylesheet" href="css/css/owl.carousel.css" type="text/css" media="all">
    <link rel="stylesheet" href="/css/css/owl.theme.css" type="text/css" media="all">
    <link rel="stylesheet" href="css/css/style.css" type="text/css" media="all" />
    <!-- Style-CSS -->
    <link href="css/css/prettyPhoto.css" rel="stylesheet" type="text/css" />
    <link href="css/css/style6.css" rel='stylesheet' type='text/css' />
        ...
        <header>
            <div class="container">
                ...
                <span class="navbar-toggler-icon"></span>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav ml-lg-auto text-center">
                            ...
                            <li class="nav-item cool">
                                <a class="nav-link" href="{{ url('admin/profesor') }}">Profesores</a>
                            </li>
                   ...
                   <img style="height:25px;width:25px;" src="{{url('/css/images/cherry-blossom.svg')}}"> {{ Auth::user()->name }} 
                        </a>
